...
int main(int argc, char** argv) {
   // ses.setBackground("/Users/paulinakekkonen/Pictures/background.jpeg");
    ...
    map[7] = {o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o};
    ...
    for(int row = 0; row < map.size(); row++) {
        for(int col = 0; col < (map[row]).size(); col++) {
            switch((map[row])[col]) {
                ...
                case m: ses.addSprite(MainPlayer::getInstance(col, row, 1, 1, 40, 3) ); break;
...
//    ses.addFunction(SDLK_n, addMainPlayer);
   // ses.addFunction(SDLK_s, showStatusInfo);
    ses.addSprite(MainPlayer::getInstance(0, 0, 1, 1, 40, 3));
